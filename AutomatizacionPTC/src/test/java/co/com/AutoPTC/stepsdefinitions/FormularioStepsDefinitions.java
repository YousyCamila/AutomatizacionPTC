...
public class FormularioStepsDefinitions {
    ...
    public void completaElFormularioConLaInformacionRequeridaYQueInicieSesionConLasCredencialesDelAdiministrador(DataTable dataTable) {
    ...
    public void seDebeMostrarUnaConfirmaciónDeEnvíoExitosoDelMensajeYSeDebeValidarEnLaListaDeResponderSolicitudesDelAdministrador() {
