...
public class CrearContratoPage {
    ...
    public static final Target BOTON_OPCIONES = Target.the("Selector de Cliente")
            .located(By.xpath("//*[@id=\"root\"]/div/div[1]/div/button"));

    public static final Target BOTON_CONTRATOS = Target.the("Botón Contratos")
            .located(By.xpath("/html/body/div[2]/div[3]/ul/li[4]/div"));
